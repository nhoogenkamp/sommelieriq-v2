    ...
    >
      {(close) => (
        <div className="wine-popup">
          ...
          <h3>Charactaristics</h3>

          <p>
            <strong>Body score:</strong> {wine.body_score}
          </p>

          <p>
            <strong>Tannin score:</strong> {wine.tannin_score}
          </p>          

          <p>
            <strong>Acidity score:</strong> {wine.acidity_score}
          </p>

          <p>
            <strong>Sweetness score:</strong> {wine.sweetness_score}
          </p>  
